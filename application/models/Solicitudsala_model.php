...
class Solicitudsala_model extends CI_Model {
    var $table = 'solicitudsala';
    var $column_order = array('codigo','fecha','horaini','horafin','cargo','requerimiento');
    var $column_search = array('codigo','fecha','horaini','horafin','cargo','requerimiento');
