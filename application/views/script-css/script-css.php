...
<script src="<?php echo base_url('assets/bootstrap-datetimepicker/js/bootstrap-clockpicker.min.js')?>"></script>
<script src="<?php echo base_url('assets/bootstrap-datetimepicker/js/highlight.min.js')?>"></script>